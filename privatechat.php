	...
	$(document).ready(function(){
			...
			else
			{
				...
				if(receiver_userid == data.userId || data.from == 'Me')
				{
					if($('#is_active_chat').val() == 'Yes')
					{
						...
						$('#messages_area2').append(html_data);

						$('#messages_area2').scrollTop($('#messages_area2')[0].scrollHeight);
		...
		function make_chat_area(user_name)
		{
			...
			<div class="card">
				<div class="card-header">
					<div class="row">
						...
						<div class="col col-sm-6 text-right">
							<a href="chatroom.php" class="btn btn-success btn-sm">Global Chat</a>&nbsp;&nbsp;&nbsp;
				...
				<div class="card-body" id="messages_area2">
