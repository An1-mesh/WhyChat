...
class ChatUser
{
	...
	function setUserLastSeen($user_last_seen)
	{
	...
	function update_user_login_data()
	{
		$query = "
		UPDATE chat_user_table 
		SET user_login_status = :user_login_status, user_last_seen = :user_last_seen, user_token = :user_token  
		...
		$statement->bindParam(':user_last_seen', $this->user_last_seen);
	...
	{
		$query = "
		SELECT user_id, user_name, user_profile, user_login_status, user_last_seen,
